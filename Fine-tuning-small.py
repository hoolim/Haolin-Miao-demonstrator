...
MODEL_OUTPUT_DIR = "./whisper-small-cantonese-english-finetuned" 
...
vectorized_dataset = raw_dataset.map(prepare_dataset, remove_columns=raw_dataset.column_names["train"], num_proc=4)
